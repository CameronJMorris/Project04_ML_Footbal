...
class Offense_Classifier:
    # makes an innit with the Offensive team and makes the model and then class filter data and fit
    ...
    # this filters the data and makes sure that it works as it is supposed to and also changes a column("Play_Called") that makes the values 0 if pass and 1 for a run and makes sure it is the right offensive team and only contains runs and passes
